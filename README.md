...
**최종 갱신:** 2026-09-02 · **상태:** 2~5세대 계산기 공개,
2·3·4·5세대 다회 청구 지원
...
| 5세대 다회 청구 | 회당·일당·연간 한도, 중증 입원 자기부담 상한 누적, 급여 통원 입력 게이트 검증 |
| 커버리지 | Statements 92.09% · Branches 85.29% · Functions 98.14% (설정 하한 통과) |
...
1. 5세대 비중증 통원의 같은 날 다회 방문을 지원하려면 날짜 축과 공제·일당 한도의 적용 단위를
   판매약관에서 확인합니다. 현재는 서로 다른 날짜의 청구만 입력하도록 제한합니다.
2. 외부 근거가 확보되면 5세대 누적기간 기산점과 `feature/` HOLD 규칙을 해제합니다.
