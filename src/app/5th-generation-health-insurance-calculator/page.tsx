    ...
    <article className="container-base py-10">
      <header className="mb-8">
        ...
        <p className="mt-3 text-slate-600 leading-relaxed">
          ...
          별도 보장종목은 연간 금액·횟수 한도가, <b>상급병실료 차액</b>은 총 입원일수가 함께 필요해
          1건만으로는 계산할 수 없으므로, <b>단건 계산은 차단</b>하고 아래 <b>여러 건 합산 계산</b>에서
          계산합니다.
        </p>
      </header>
      ...
      <div className="mt-6">
        <NoticeBox variant="info">
          ...
          산식(비급여 병실료의 50%, 1일 평균 10만 원 한도)이 적용됩니다. 여러 건 합산 계산에서
          입원별 차액과 총 입원일수를 입력하면 계산합니다. 연간 보험가입금액은 일반 입원·통원
          보상금액과 같은 한도를 나눠 씁니다.
        </NoticeBox>
      </div>
