...
export const metadata: Metadata = {
  ...
  description:
    "여러 보험사에서 받은 자동차보험 견적을 입력하면 최저·최고·차액과 월 환산 차액을 비교합니다. 보험료를 추정하지 않고, 입력한 견적만 비교합니다.",
    ...
    <article className="container-base py-10">
      <header className="mb-8">
        ...
        <p className="mt-3 text-slate-600 leading-relaxed">
          여러 보험사에서 받은 자동차보험 견적을 나란히 비교합니다. 견적 금액을 입력하면 최저·최고 견적과
          차액, 월 환산 차액을 계산합니다. 보험료를 추정하지 않고, 입력한 견적만 비교하는 도구입니다.
        </p>
      </header>
