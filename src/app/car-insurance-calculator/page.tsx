  ...
  return (
    <article className="container-base py-10">
      ...
      <div className="mt-6">
        <NoticeBox>
          <strong>
            본 계산 결과는 임의의 단순 추정 배율을 적용한 참고값이며, 보험개발원 또는 개별
            보험사의 실제 보험료 산출 요율을 적용한 견적이 아닙니다.
          </strong>{" "}
          보험사마다 요율과 할인·할증 기준이 크게 달라 실제 보험료와 차이가 클 수 있으니,
          정확한 보험료는 보험다모아 또는 각 보험사 다이렉트 견적을 통해 확인하시기 바랍니다.
        </NoticeBox>
      </div>
