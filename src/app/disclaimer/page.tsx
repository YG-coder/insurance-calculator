...
export const metadata: Metadata = {
  title: "면책사항",
  description:
    "보험계산기 사이트의 계산 결과는 이용자가 입력한 값을 기준으로 한 참고용 정보입니다. 실제 보험료·보험금과의 차이, 정보 활용 범위, 면책 범위, 책임의 한계를 안내합니다.",
...
export default function DisclaimerPage() {
  ...
  const faqs = [
    {
      ...
      a: "본 사이트의 계산 결과는 참고용이며, 실제 보험료·보험금과의 차이에 대해 보험계산기.kr은 어떠한 책임도 지지 않습니다. 대부분의 계산기는 이용자가 입력한 값을 산수로 계산하지만, 실제 보험 거래에서 발생하는 분쟁은 해당 보험사와 금융감독원 분쟁조정 절차를 통해 해결하시기 바랍니다.",
    },
    {
  ...
  return (
    <article className="container-base py-10">
      ...
      <div className="mb-6">
        <NoticeBox>
          <strong>본 사이트의 계산 결과는 참고용입니다.</strong>{" "}
          대부분의 계산기는 이용자가 직접 입력한 값을 산수로 계산하지만, 실제 보험료·보험금·자기부담금은
          보험사 상품, 약관, 가입 시기, 특약, 가입자의 상황에 따라 달라질 수 있으며, 본 사이트는 그 차이에
      ...
      <section className="prose-seo">
        ...
        <p>
          보험계산기는 일반 소비자가{" "}
          <strong>보험을 유지할지 해지할지, 보장이 얼마나 부족한지 등 보험 의사결정에 필요한 숫자</strong>를
          직접 계산해 볼 수 있도록 만든 무료 참고용 도구입니다. 실손보험 자기부담금, 해지환급금,
          사망보장 필요액, 보장 공백 등 대부분의 계산은 이용자가 입력한 값을 산수로 계산하며, 사이트가
          임의의 평균값이나 추정치를 만들어 제시하지 않습니다. 본 사이트의 콘텐츠는 보험·금융·세무·법률
          분야의 전문 자문이 아니며, 특정 보험 상품의 가입·해지·청구 결정을 위한 단독 근거로 사용하기 위해
          제공되지 않습니다.
        </p>
