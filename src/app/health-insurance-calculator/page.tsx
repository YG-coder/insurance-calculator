...
import HealthCalcMulti2021 from "@/components/calculators/HealthCalcMulti2021";
...
export default function HealthPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "도수치료, MRI/CT 일부, 비급여 주사제, 비급여 검사 등이 대표적입니다. 4세대 실손에서는 보험료 갱신 전 1년간 비급여 보험금 수령액에 따라 비급여 보험료가 할인·유지·할증됩니다. 산정특례 대상 질환 등 일부 의료비는 등급 산정에서 제외될 수 있습니다.",
    },
  ];
    ...
    <article className="container-base py-10">
      ...
      <section className="mt-14 prose-seo">
        ...
        <p>
          ...
          4세대(2021년 7월 출시) 등으로 구분되며 세대별로 자기부담률, 한도, 갱신 주기 등이 다릅니다.
          4세대 실손보험은 비급여 청구 실적에 따라 보험료가 할인·할증되는 차등제가
          도입된 것이 특징입니다.
        </p>
