...
export default function HealthPage() {
  const faqs = [
    ...
    {
      q: "통원과 입원의 자기부담금 차이는?",
      a: "통원의 경우 회당 최소공제액(보통 1~2만 원)이 적용되며, 입원은 일반적으로 자기부담률이 더 낮게 설계됩니다. 또한 입원은 한도가 1년에 5천만 원~1억 원으로 통원보다 큽니다.",
    },
    {
    ...
    <article className="container-base py-10">
      <header className="mb-8">
        ...
        <p className="mt-3 text-slate-600 leading-relaxed">
          ...
          계산해보세요. 급여/비급여, 입원/통원에 따라 본인부담률이 다르게 적용됩니다.
        </p>
      </header>
      ...
      <div className="mt-6">
        <NoticeBox>
          <strong>실제 보험금은 상품, 약관, 가입 시기에 따라 달라질 수 있습니다.</strong> 본
          계산기는 4세대 실손보험 기준의 일반적인 자기부담률을 단순화하여 적용한 참고용 도구이며,
          정확한 보장 내역은 가입하신 보험사 약관과 청구 안내를 확인하시기 바랍니다.
        </NoticeBox>
      </div>
      ...
      <section className="mt-14 prose-seo">
        ...
        <ul>
          <li>
            <strong>급여 + 통원:</strong> 본인부담률 20% 또는 최소공제액 중 큰 금액
          </li>
          <li>
            <strong>급여 + 입원:</strong> 본인부담률 약 10%
          </li>
          <li>
            <strong>비급여 + 통원:</strong> 본인부담률 30% 또는 최소공제액 중 큰 금액
          </li>
          <li>
            <strong>비급여 + 입원:</strong> 본인부담률 약 20%
          </li>
        </ul>
        <p>
          여기서 ‘최소공제액’은 통원 1회당 1~2만 원 수준으로 설정되어 있어, 소액 치료의 경우
          정률보다 최소공제액이 적용되는 경우가 많습니다. 또한 비급여 항목의 경우 일부 특약(도수
          치료, 비급여 주사 등)은 별도의 한도와 횟수 제한이 적용됩니다.
        </p>

        <h2>실제 예시: 30만 원 비급여 통원 진료</h2>
        <p>
          예를 들어 비급여 통원 진료비가 <strong>30만 원</strong>인 경우, 4세대 실손보험 기준 자기
          부담률 30%를 적용하면 본인부담금은 9만 원, 보험으로 적용받는 금액은 21만 원이 됩니다.
          다만 이는 단순 추정이며, 실제로는 진료 항목별 한도, 보장 제외 항목, 비급여 차등제 등에
          따라 결과가 달라질 수 있습니다.
        </p>
        <p>
          또 다른 예로, 급여 입원 치료비가 <strong>200만 원</strong>이고 자기부담률이 10%라면 본인
          부담금 20만 원, 보험금 180만 원이 산출됩니다. 입원의 경우 통원에 비해 자기부담률이 낮고
          한도가 크기 때문에 큰 의료비 발생 시 보장 비율이 상대적으로 높은 편입니다.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>한도 초과 인지하지 못함:</strong> 통원 1일 30만 원, 처방 1일 10만 원 등 일별
            한도를 초과한 부분은 보장되지 않습니다.
          </li>
          <li>
