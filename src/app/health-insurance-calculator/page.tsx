...
export default function HealthPage() {
  const faqs = [
    ...
    {
      q: "통원과 입원의 자기부담금 차이는?",
      a: "자기부담률 자체(급여 20%, 비급여 30%)는 입원과 통원이 동일합니다. 다만 통원은 회당 최소공제액(급여 1~2만 원, 비급여 3만 원)이 추가로 적용되어 소액 진료비의 경우 정률보다 최소공제액이 본인부담금이 되는 경우가 많고, 입원은 별도의 최소공제액 없이 정률만 적용됩니다. 또한 입원은 한도가 1년에 5천만 원~1억 원으로 통원보다 큽니다.",
    },
    {
    ...
    <article className="container-base py-10">
      ...
      <section className="mt-14 prose-seo">
        ...
        <p>
          ...
          부담금 40만 원, 보험금 160만 원이 산출됩니다. 입원은 자기부담률 자체는 통원과 동일하지만
          최소공제액이 없고 연간 한도가 크기 때문에, 고액 의료비가 발생했을 때 통원 대비 보장 비율이
          상대적으로 안정적인 편입니다.
        </p>
