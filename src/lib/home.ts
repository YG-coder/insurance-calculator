...
export const HOME_GROUPS = [
  ...
  { id: "budget", label: "보험료·견적 점검", question: "", description: "", start: { href: "/insurance-premium-calculator", label: "보험료 비중 계산" }, hub: "/guide", guide: "", calculators: ["/insurance-premium-calculator", "/car-insurance-calculator"] },
