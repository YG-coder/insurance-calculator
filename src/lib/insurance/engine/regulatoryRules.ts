...
export const REGULATORY_RULES = {
  ...
  GEN2026_ROOM_CHARGE_DEDUCTIBLE_POOL: held(
    ...
    "확인된 것: 상급병실료 차액 행에는 '공제금액'이라는 용어가 없고 보상금액(50%)만 규정된다. 제2조 정의는 보장대상의료비에서 비급여 병실료 중 보장하지 않는 금액을 제외한다. 확인되지 않은 것: 제5조⑤의 '상해·질병 및 3대비급여 의료비 중 공제금액'에 상급병실료 차액의 미지급 50%가 포함되는지. 명시적 근거나 공식 해석을 찾지 못해 pool을 적용하지 않는다",
    "2026-09-03",
  ),
